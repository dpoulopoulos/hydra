 ...
 */
export const emailVerificationSendVerificationEmailMe = <ThrowOnError extends boolean = false>(options?: Options<EmailVerificationSendVerificationEmailMeData, ThrowOnError>): RequestResult<EmailVerificationSendVerificationEmailMeResponses, unknown, ThrowOnError> => (options?.client ?? client).post<EmailVerificationSendVerificationEmailMeResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const emailVerificationCancelPendingEmailChangeMe = <ThrowOnError extends boolean = false>(options?: Options<EmailVerificationCancelPendingEmailChangeMeData, ThrowOnError>): RequestResult<EmailVerificationCancelPendingEmailChangeMeResponses, unknown, ThrowOnError> => (options?.client ?? client).delete<EmailVerificationCancelPendingEmailChangeMeResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * or the user is inactive (403).
 */
export const emailVerificationGetPendingEmailChangeMe = <ThrowOnError extends boolean = false>(options?: Options<EmailVerificationGetPendingEmailChangeMeData, ThrowOnError>): RequestResult<EmailVerificationGetPendingEmailChangeMeResponses, unknown, ThrowOnError> => (options?.client ?? client).get<EmailVerificationGetPendingEmailChangeMeResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/email-verification/me/email-change',
    ...options
});
 ...
 */
export const emailVerificationResendPendingEmailChangeMe = <ThrowOnError extends boolean = false>(options?: Options<EmailVerificationResendPendingEmailChangeMeData, ThrowOnError>): RequestResult<EmailVerificationResendPendingEmailChangeMeResponses, unknown, ThrowOnError> => (options?.client ?? client).post<EmailVerificationResendPendingEmailChangeMeResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const emailOutboxReadEmailOutboxStats = <ThrowOnError extends boolean = false>(options?: Options<EmailOutboxReadEmailOutboxStatsData, ThrowOnError>): RequestResult<EmailOutboxReadEmailOutboxStatsResponses, unknown, ThrowOnError> => (options?.client ?? client).get<EmailOutboxReadEmailOutboxStatsResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
