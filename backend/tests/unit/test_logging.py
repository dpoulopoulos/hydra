...
class TestLogging:
    ...
    def test_log_level_map_contains_all_environments(self) -> None:
    ...
    def test_log_level_map_local_is_debug(self) -> None:
    ...
    def test_log_level_map_staging_is_info(self) -> None:
    ...
    def test_log_level_map_production_is_warning(self) -> None:
