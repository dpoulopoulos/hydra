...
class TestMarketValueMinor:
    ...
    def test_whole_units_at_a_whole_price(self) -> None:
    ...
    def test_fractional_units_are_not_lost(self) -> None:
    ...
    def test_a_price_below_a_cent_still_counts(self) -> None:
    ...
    def test_nothing_held_is_worth_nothing(self) -> None:
...
class TestConvertMinor:
    ...
    def test_converts_at_the_rate(self) -> None:
    ...
    def test_the_identity_rate_changes_nothing(self) -> None:
...
class TestApportionMinor:
    ...
    def test_takes_the_proportional_share(self) -> None:
    ...
    def test_selling_in_pieces_takes_the_whole_basis(self) -> None:
    ...
    def test_nothing_held_yields_nothing(self) -> None:
...
class TestMinorDigits:
    ...
    def test_the_usual_currency_has_two(self) -> None:
    ...
    def test_a_currency_with_no_decimals(self) -> None:
    ...
    def test_a_currency_with_three_decimals(self) -> None:
    ...
    def test_the_code_is_read_without_regard_to_case(self) -> None:
